  ...
  return (
    <>
      ...
      <div className='image bg-red-500 h-[550px]'>
        ...
        <h1 className='font-sans text-6xl font-semibold text-white text-start' > الدراسات العليا</h1>
          <p className='font-sans text-2xl font-medium text-white text-start mt-9' >كل مايحتاجه الطالب من مدخل واحد: تسجيل المقررات، دفع المصروفات<br/>، منصة التعليم الإلكترونى، الجداول الدراسية، جداول الامتحانات، النتائج</p>   
          <div className='flex items-end'>
          <button className=' bg-gradient-to-t w-[13rem] from-[#51ACD0] to-[#5dc6f0] p-2 rounded-md  text-2xl mt-9 text-white font-serif font-semibold cursor-pointer hover:bg-teal-400  '>تسجيل الدخول</button> 
      ...
      <div className='services-name ms-10 mt-10 before:content-[""] before:block'>
        <h1 className='font-sans text-5xl font-semibold  text-start'>الخدمات الذكية</h1>
      </div>
      ...
      <div className='shadow-lg text-center mb-10 rounded-lg w-90 p-5 hover:scale-110 transition-all'>
          <img src='https://www.asu.edu.eg/141090/_mediacenter/2020/png/372c6de72afbddfc800432ce0f8b178b.png' style={{width:"150px"}}  alt=''/>
         ...
         <div className='shadow-lg text-center mb-10 rounded-lg w-90 p-5 hover:scale-110 transition-all'>
          <img src='https://www.asu.edu.eg/141090/_mediacenter/2020/png/372c6de72afbddfc800432ce0f8b178b.png' style={{width:"150px"}}  alt=''/>
          <h3 className='mt-5 mb-5'>التقدم للدراسات العليا</h3>
         </div>  <div className='shadow-lg text-center mb-10 rounded-lg w-90 p-5 hover:scale-110 transition-all'>
          <img src='https://www.asu.edu.eg/141090/_mediacenter/2020/png/372c6de72afbddfc800432ce0f8b178b.png' style={{width:"150px"}}  alt=''/>
          <h3 className='mt-5 mb-5'>التقدم للدراسات العليا</h3>
         </div>  <div className='shadow-lg text-center mb-10 rounded-lg w-90 p-5 hover:scale-110 transition-all'>
          <img src='https://www.asu.edu.eg/141090/_mediacenter/2020/png/372c6de72afbddfc800432ce0f8b178b.png' style={{width:"150px"}}  alt=''/>
