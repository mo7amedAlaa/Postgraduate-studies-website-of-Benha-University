        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                ...
                <div className="flex gap-5">
                        <button className="font-sans bg-main shadow-md text-white p-2 rounded">Edit</button>
                        <button className="font-sans bg-red-500 shadow-md text-white p-2 rounded">Delete</button>
