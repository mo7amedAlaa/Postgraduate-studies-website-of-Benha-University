...
export default function Navbar() {
  ...
  return (
    <nav className="navba bg-gradient-to-t from-[#51ACD0] to-[#5dc6f0] px-2 py-2 lg:mb-3 ">
      <div className="container mx-auto   flex flex-row justify-between  items-center">
        ...
        <div className="pageTitle hidden  md:flex flex items-center justify-between ">
          <img src={BfcaiLogo} alt="درسات عليا" className="w-12 float-start" />
          <span className="text-black font-[900] text-[18px]  inline-block font-[Tajawal]     ">
            كلية الحاسبات والذكاء الاصطناعي -جامعة بنها
          </span>
        </div>
        <div className="BUlogo flex items-center justify-between">
